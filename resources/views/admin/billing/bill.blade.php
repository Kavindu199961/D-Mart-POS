<!DOCTYPE html>
    ...
    <body>
        <div class='invoice-container'>
            ...
            <tbody>
    @php
        // First check if $items is not already set (from controller)
        $displayItems = $items ?? json_decode($sale->items, true);
        ...
        for ($i = 0; $i < 10; $i++) {
            if ($i < $itemCount) {
                ...
                echo '<tr>
                    ...
                    <td class="text-right">' . number_format(($item['sale_price'] ?? 0) * ($item['quantity'] ?? 1), 2) . '</td>
                </tr>';
            } else {
                echo '<tr>
                    <td>&nbsp;</td>
